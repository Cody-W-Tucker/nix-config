{
  ...
  inputs = {
    ...
    nextmeeting = {
      url = "github:Cody-W-Tucker/nextmeeting-waybar?dir=packaging";
      inputs.nixpkgs.follows = "nixpkgs";
    };
  };

  outputs = inputs@{ self, nixpkgs, nixpkgs-unstable, home-manager, sops-nix, nixos-hardware, stylix, nixvim, nextmeeting, ... }:
    let
      system = "x86_64-linux";
      pkgs = import nixpkgs {
        system = system;
