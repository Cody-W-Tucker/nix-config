...
{
  # VPN-specific Transmission wiring: confinement, WireGuard namespace,
  # and Transmission service settings. Media directory creation lives in
  # the parent media module (default.nix) since it is shared across
  # services.
