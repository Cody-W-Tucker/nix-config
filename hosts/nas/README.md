...
| NIC          | `enp6s0` — 192.168.1.2/24 (static; temporary .108 recovery alias), IPv6 ULA `fd43:fa14:b975:8::/64`. |
...
| ------------ | --------------------------- | ------------------------------------------------- |
| `enp6s0`     | 192.168.1.2/24 static + temporary .108 alias + IPv6 ULA | Primary LAN, DNS server for router. |
