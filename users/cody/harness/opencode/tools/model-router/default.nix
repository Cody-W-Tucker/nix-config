    ...
    pkgs.runCommandLocal "opencode-model-router-src"
      ...
      ''
        ...
        jq '
          ...
          | .presets.openai.medium.model = "litellm/hy3"
          | .presets.openai.medium.variant = "high"
          | .presets.openai.medium.description = "Hy3 High — implementation, refactors, and standard coding work"
          | .presets.openai.heavy.model = "litellm/gpt-5.6-terra"
