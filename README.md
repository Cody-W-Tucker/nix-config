...
- Local models are served through [`llama-swap`](./modules/services/llama-swap/default.nix) with supporting STT and TTS services around them.
...
- [OpenCode](./users/cody/desktop/harness/opencode/default.nix) is wired with [custom agents](./users/cody/desktop/harness/opencode/agents), [skills](./users/cody/desktop/harness/opencode/skills), [plugins and tools](./users/cody/desktop/harness/opencode/tools), secret-backed MCP wrappers, and repo context.
...
- The desktop setup is also part of the idea. [Hyprland](./modules/desktop/hyprland.nix), [Waybar](./users/cody/desktop/waybar.nix), and the surrounding session wiring are configured to reduce friction in day to day use.
