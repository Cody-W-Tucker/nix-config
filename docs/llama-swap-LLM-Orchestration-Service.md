...
| -------------- | ---------------------- | -------------------------------- | -------------------------------------- |
| **Chat**       | `qwen3.5-9b-nvfp4`     | `gpuLayers = 999`                | General reasoning and conversation.    |
...
- **Chat Model**: `qwen3.5-9b-nvfp4`[modules/nas/karakeep.nix12](../modules/nas/karakeep.nix#L12-L12)
